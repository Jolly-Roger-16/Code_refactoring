...
### Выполненное исправление 10

Функция DialogScreen вынесена из MainActivity.kt
в файл ui/screens/dialog/DialogScreen.kt.

AppNavigation.kt импортирует диалоговый экран из пакета
ui.screens.dialog.

MainActivity.kt больше не содержит реализацию диалогового
UI-компонента.

Связанный коммит:
`refactor: диалоговый экран вынесен из MainActivity`
